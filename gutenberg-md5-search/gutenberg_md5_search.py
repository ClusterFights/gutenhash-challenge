...
# check for working directories and create them if they don't exist
def create_dirs(dl_dir='books'):
...
def main():
    ...
    if not os.path.exists('book_urls.txt'):
        page_w_books_url = 'http://www.gutenberg.org/robot/harvest?filetypes[]=' + \
                            filetype + '&langs[]=' + lang
...
if __name__ == '__main__':
    """
    The main function is called when this file is run from the command line
    """
